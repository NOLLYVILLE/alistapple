...
#         'latest2': latest2,
#     }
#     # return HttpResponse('I am determine to be a certified programmer')
#     return render(request, 'index.html', context)
...
#         if form.is_valid():
#             form.save()
#             messages.success(request, "Your message has benn sent! Our customer service team will reach you soon.")
#             return redirect('/contact')
